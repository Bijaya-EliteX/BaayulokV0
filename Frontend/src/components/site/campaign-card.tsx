...
import { formatNpr, resolveImageUrl, type CampaignData } from "@/lib/api";
  ...
  return (
    ...
    >
      <div className="relative aspect-[16/10] overflow-hidden">
        <img src={resolveImageUrl(c.coverImage)} alt={c.title} loading="lazy" className="h-full w-full object-cover transition duration-500 group-hover:scale-105" />
